...
while running:
    ...
    if cutscene_bool:
        Cutscene.scene(screen, cutscene)
    elif cutscene_bool == False:
        if button.visible:
            button.Menu(screen)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if event.button == 1:
                for enemy in enemies:
                    if math.sqrt((player_x - enemy.x) ** 2 + (player_y - enemy.y) ** 2) < 00:
                        enemy.hit_count += 1
        ...
        for enemy in enemies:
            ...
            enemy.update(index, player_x, player_y, shift_x, shift_y, x1_enemy, x2_enemy, y1_enemy, y2_enemy,
                         x1_enemy1, x2_enemy1, y1_enemy1, y2_enemy1, x1_enemy2, x2_enemy2, y1_enemy2, y2_enemy2)
